...
einholen. Die Funktion der Formulare wird [weiter unten]() genauer erläutert.
...
2. Klicken Sie auf {{<icon "folder-tree">}} **Datei Wählen...**
...
und sicher bei Ihnen landen. So sparen Sie sich Zeit die Lohndaten einzufordern
und müssen sie auch nicht mehr händisch übertragen, was Fehler vermeidet. Wenn
Sie nun noch die [Sofortmeldungsfunktion]() nutzen, werden die Daten automatisch
an die Rentenversicherung weitergeleitet ohne, dass Sie auch nur einmal
Sozialversicherungsnummer und co. händisch übertragen müssen. 
...
gespeichert und noch mit dem Zusatz <a style="color:#0FAEBE;"> 'In Bearbeitung' </a> versehen.
