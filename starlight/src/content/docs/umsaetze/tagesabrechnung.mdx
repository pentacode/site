...
<Figure caption="Bei Eingabe von ">
![](/uploads/ta8.png)
</Figure>
...
**Drucken** Sie in diesem Fall idealerweise die Tagesabrechnung über das <FAIcon name="print" />-Symbol aus und **unterzeichnen** Sie den Ausdruck.
