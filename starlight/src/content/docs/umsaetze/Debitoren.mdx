...
<Figure caption="Auf einen Blick eine Übersicht über alle Käufe auf Rechnung des aktuellen Jahres.">
<img src="/umsaetze/Debitoren/debitoren-übersicht.png"/>
</Figure>
...
-  **bezahlt und unbezahlt** - normalerweise werden Ihnen nur unbeglichene
   ...
   einsehen, klicken Sie auf den Regler <Button label="bezahlt" icon="toggle-on" /> in der oberen rechten Ecke
   neben dem Suchen... Dialogfeld

<Figure caption="So können wir das gesamte Jahr 2021 nach einem spezifischen Debitor durchsuchen.">
<img src="/umsaetze/Debitoren/debitoren-filter.gif"/>
</Figure>
