...
Sie können weitere Standorte anlegen, indem Sie auf <Button label="Neuer Standort" icon="plus" /> klicken.
...
<img src="/einstellungen/arbeitsbereiche/neuer_standort.webp"/>
</Figure>
...
<img src="/einstellungen/arbeitsbereiche/standort_feiertage.gif"/>
</Figure>

## Standort bearbeiten

Durch Anklicken des <FAIcon name="ellipsis-h" />-Symbols am rechten oberen Eck können
...
<img src="/einstellungen/arbeitsbereiche/standort_bearbeiten.webp"/>
</Figure>

## Standort archivieren

Wenn Sie einen Standort **nicht mehr benötigen** sollten und auch nicht wollen, dass dieser weiterhin in Ihrer Datenbank erscheint, können Sie ihn über das <FAIcon name="archive" />-Symbol **archivieren**. Der Standort ist dann nicht mehr sichtbar, alle Daten, also alle Angaben zu Mitarbeitern, Arbeitszeiten und Kassenbuch bleiben jedoch erhalten.
...
<img src="/einstellungen/arbeitsbereiche/neue_abteilung.webp"/>
</Figure>


> <FAIcon name="lightbulb" /> Positionen ordnen Sie ihren händisch Mitarbeitern zu. Die Abteilung wird dem Mitarbeiter hingegen automatisch zugeteilt, sobald diesem eine Position zugeordnet wird. Nach den Abteilungen ordnet der Dienstplan.
...
Bearbeiten Sie hierzu die Abteilung, klicken Sie auf das <FAIcon name="ellipsis-h" /> Symbol und dann auf <Button label="Abteilung Archivieren" icon="archive" />.
