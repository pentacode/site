...
4. Wählen Sie, ob Dokumente dieser Kategorie dem Mitarbeiter angezeigt oder verborgen bleiben sollen, indem Sie zwischen <FAIcon name="eye" /> und <FAIcon name="eye-slash" /> mit einem Klick wählen.
5. Klicken Sie den <Button label="Speichern" />-Button.

> **Tipp** <FAIcon name="lightbulb" /> Mit den vorgefertigten Farben nicht zufrieden?
...
- Um Dokumente einer Kategorie für Mitarbeiter anzuzeigen oder verborgen zu halten klicken Sie auf das <FAIcon name="eye" /> Symbol.
- Wollen Sie eine Kategorie löschen fahren Sie mit dem Cursor über die Kachel der Kategorie
und drücken auf den <FAIcon name="trash" /> **Button**. 
