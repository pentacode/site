...
<img src="/dashboard/dashboard.webp" />
</Figure>
...
[Dienstplanansicht](/dienstplan/) und hebt die ausgewählte Schicht hervor - halten Sie dabei <Button label="Shift" icon="up" /> gedrückt und Sie landen im Arbeitszeitblatt des Mitarbeiters.
...
Über das <FAIcon name="toggle-on" />-**Icon** können Sie selbst festlegen, welche
...
Sie können ebenfalls die Anordnung der Kacheln ändern, indem Sie das <FAIcon name="grip-vertical" />-**Icon** mit der Maus festhalten und den jeweiligen Eintrag in eine neue Position ziehen. 
...
Wenn sich das Icon zu einem <FAIcon name="gear" /> wandelt, können Sie mit einem Klick darauf
die Einstellungen der Kachel anpassen. 

> <FAIcon name="lightbulb" /> **Wichtig:** Die angezeigten Kacheln unterliegen stets den Ihnen als Manager zugewiesenen Zuständigkeitsbereichen und Berechtigungen.
