...
In die Ausschreibungsübersicht gelangen Sie über den Punkt <Button label="Recruiting" icon="image-polaroid-user" /> im Hauptmenü. Hier können Sie
...
<img src="/recruiting/übersicht.png" />
</Figure>
...
1. Klicken Sie auf <Button label="Neue Ausschreibung" icon="plus" /> unter der
...
> <FAIcon name="lightbulb" /> **Tipp:** Erwarten Sie bestimmte Angaben von Ihren
...
> <FAIcon name="info-circle" /> **Keine Panik:** Alle in der Ausschreibung
...
> **Achtung** <FAIcon name="exclamation" /> Achten Sie darauf während des Erstellens
...
zwischenspeichern und mit der Tastenkombination <Key>strg</Key> + <Key>V</Key>
nun beliebig einfügen.

> <FAIcon name="lightbulb" /> **Tipp:** Posten Sie den Bewerbungslink am Ende ihrer
...
<img src="/recruiting/bewerberansicht.png"/>
</Figure>
...
<img src="/recruiting/personaleransicht.png" />
</Figure>
...
[Detailansicht](#bewerber-einsehen) des Bewerbers und klicken auf <Button label="Einstellen" icon="handshake" />.
...
> <FAIcon name="lightbulb" /> **Tipp:** In vielen Fällen möchten Sie den Kandidaten
...
und klicken Sie auf <Button label="Ablehnen" icon="handshake-slash" />.
Der Kandidat wird dann von der List der Bewerber entfernt.

> <FAIcon name="exclamation-triangle" /> **Achtung:** Abgelehnte Bewerber werden
