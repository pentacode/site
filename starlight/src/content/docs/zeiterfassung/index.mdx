...
> <Icon name="info-circle" /> **Info:** Der Verbindungscode der Stempeluhr **ändert sich mit jedem erfolgreich eingeloggten Gerät** - wollen Sie ein weiteres Gerät als Stempeluhr verbinden, müssen Sie den aktualisierten Verbindungscode unter **Stempeluhr Bearbeiten** einsehen!
...
> <Icon name="info-circle" /> **Info:** Unter **Stempeluhr Bearbeiten** können Sie auch den **Verbindungscode** erneut einsehen - dieser wird automatisch erstellt.
...
> **<Icon name="info-circle" /> Achtung:** Durch das Löschen der Stempeluhr im Zeiterfassungs-Dashboard wird das verbundene Endgerät automatisch getrennt und es sind keine Arbeitszeiten mehr darüber erfassbar! Aber keine Sorge: Es werden weder Arbeitszeiten noch Zeiterfassungsereignisse gelöscht.
