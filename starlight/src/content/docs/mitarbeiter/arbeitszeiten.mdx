...
Im Arbeitszeitblatt können Sie genau wie in der Übersicht jeden gewünschten Zeitraum genauer betrachten. Klicken Sie auf das <Icon name="calendar" /> **Symbol**, um den Zeitraum auszuwählen, welcher angezeigt werden soll. Dabei kann maximal ein Zeitraum von 70 Tagen gewählt werden. 
...
> <Icon name="lightbulb" /> **Tipp:** Verwenden Sie Ihre Tastatur, um noch
...
> <Icon name="lightbulb" /> **Tipp:** Falls Sie bereits Arbeitszeiten für diesen
...
> Mehr zu Schichtvorschlägen erfahren Sie im [<Icon name="table" />
...
> <Icon name="lightbulb" /> **Tipp:** Um beim Selektieren eines Eintrags direkt in
...
Unter dem Punkt <Icon name="user" /> **Position** können Sie über ein Dropdown-Menü
...
Unter dem Punkt <Icon name="calendar" /> **Geplant** können Sie den geplanten
Schichtbeginn, das geplante Schichtende sowie die geplante Pause bearbeiten.

> <Icon name="info-circle" /> **Hinweis:** Dieser Bereich ist nur bearbeitbar,
...
> <Icon name="lightbulb" /> **Tipp:** Lassen Sie eines oder beide dieser Felder
...
Über das rechte Eingabefeld (erkennbar durch das <Icon name="coffee" /> Symbol)
...
zur Anwendung kommen, erfahren Sie in dem Hilfeartikel [<Icon name="cog" />
Einstellungen / <Icon name="stopwatch" />
Zeiterfassung]\(/handbuch/einstellungen/zeiterfassung#pausenberechnung).

### Gestempelte Arbeitszeiten

Unter dem Punkt <Icon name="stopwatch" /> **Gestempelt** finden Sie die über die
...
Unter dem Punkt <Icon name="check" /> **Erfasst** können Sie die Schichtzeiten
...
> <Icon name="info-circle" /> **Hinweis:** Änderungen an den erfassten
...
> <Icon name="info-circle" /> **Hinweis:** Falls für die aktuelle Schicht der
...
Im Feld <Icon name="utensils" /> **Essen** können Sie eingeben, ob Mitarbeiteressen
für die aktuelle Schicht gebucht werden sollen. Es wird unterschieden zwischen
**<Icon name="pancakes" /> Frühstück**, **<Icon name="burger-fries" /> Mittagessen**
und **<Icon name="plate-utensils" /> Abendessen**.

> <Icon name="info-circle" /> Zusätzlich zu manuellen Buchen von Mitarbeiteressen
...
Über das Feld <Icon name="euro-sign" /> **Umsatz** können Sie erfassen, wie viel
Umsatz der Mitarbeiter während der Schicht eingenommen hat. Dieser Wert wird für
die Berechnung der Provision herangezogen.

> <Icon name="info-circle" /> **Hinweis:** Dieses Feld ist nur dann bearbeitbar,
> wenn im Vertrag des Mitarbeiters eine Provision hinterlegt ist.

### Bemerkungen

Über das <Icon name="comment" /> **Bemerkungen**-Feld können Sie einen Kommentar für die Schicht hinterlegen.

### Zeiterfassungs-Regeln

Unter dem Punkt <Icon name="sliders-h" /> **Regeln** sehen Sie den für diese
Schicht geltenden
...
> <Icon name="lightbulb" /> **Tipp:** Sie wissen nicht, was die angezeigten Symbole
...
> <Icon name="lightbulb" /> **Tipp:** Mit der Tastenkombination <Key>⇧</Key> **+**
> <span class='fake-button'> <Icon name="delete-left" /> </span> löschen Sie eine
...
> <Icon name="info-circle" /> **Hinweis:** Freie Tage dienen nur als
...
3. Es öffnet sich ein Dialog, in dem Sie den Abweisenheits-Zeitraum und die zu
   ...
   Informationen zur Erfassung von Abwesenheiten finden Sie im [<Icon name="umbrella-beach" />
   Abwesenheiten]\(/handbuch/mitarbeiter/abwesenheiten#neue-abwesenheit-erfassen)
   Hilfeartikel.

> <Icon name="info-circle" /> **Hinweis:** aus Gründen der Übersichtlichkeit haben
...
> <Icon name="person-chalkboard" /> **Beispiel:** Ein Mitarbeiter hat eine
...
> <Icon name="lightbulb" /> **Tipp:** Sie können neben ganzen Urlaubstagen auch
...
> <Icon name="person-chalkboard" /> **Beispiel:** Ein Mitarbeiter hat eine größere
...
Klicken Sie auf das <Icon name="download" /> mittig-oben auf dem
...
2. Klicken Sie auf das <Icon name="file-lock" /> Symbol in der rechten oberen Ecke.
...
> <Icon name="exclamation-triangle" /> **Achtung:** Das Festschreiben von Konten kann **nicht rückgängig gemacht werden!**
