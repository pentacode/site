...
Um einen Vorschuss zu löschen, navigieren Sie in die Einzelansicht des Mitarbeiters und klicken auf <Icon name="trash" /> neben dem zu löschenden Vorschuss. Ein Klick auf <Button label="Bestätigen" /> löscht den Vorschuss endgültig. 

## Drucken

Über das <Icon name="print" />-Symbol können Sie die Vorschussliste, wenn gewünscht auch ausdrucken.
