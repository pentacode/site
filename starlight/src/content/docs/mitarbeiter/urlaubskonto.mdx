...
<img src="/mitarbeiter/urlaubskonto/urlaubskonto_zeitraum.gif"/>
</Figure>


> <FAIcon name="lightbulb" /> Werden zukünftige Monate mit ausgewählt, sind geplante Urlaubstage in den 'Genommenen' Tagen enthalten!

### Nach Mitarbeitern filtern

Wie in anderen Übersichten können Sie auch im Urlaubskonto nach **Positionen, Beschäftigungsverhältnis und einzelnen Mitarbeitern** filtern. Klicken Sie dazu einfach auf die Leiste mit dem <FAIcon name="filter" /> Symbol und wählen aus der Liste die gewünschten Kategorien aus. 
...
<img src="/mitarbeiter/urlaubskonto/filter_urlaubskonto.gif"/>
</Figure>
...
<img src="/mitarbeiter/urlaubskonto/einzelansicht_urlaubskonto.png"/>
</Figure>
