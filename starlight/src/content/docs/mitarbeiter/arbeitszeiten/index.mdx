...
<img src="/mitarbeiter/arbeitszeiten/arbeitszeiten_überblick.webp" />
</Figure>

Über das Feld <Button label="Filter Hinzufügen..." icon="filter" /> können Sie nach einzelnen Abteilungen und Vertragsarten suchen. Beachten Sie, dass wenn Sie eine Abteilung aussuchen **Ihnen nur Arbeitszeiten aus der betroffenen Abteilung angezeigt werden** und diese nicht die ganze Arbeitszeit einzelner Mitarbeiter darstellt. In der rechten oberen Leiste können Sie zusätzlich auswählen, nach welchem Kriterium die Mitarbeiter in der Liste aufgeführt werden sollen. 

Um zur Arbeitszeiten-Übersicht zu gelangen, wählen Sie den Punkt <Button label="Mitarbeiter" icon="people-group" /> aus dem Hauptmenü und dort den Unterpunkt <Button label="Arbeitszeiten" icon="hourglass-clock" />.
...
<img src="/mitarbeiter/arbeitszeiten/übersicht.gif" />
</Figure>
...
Im Arbeitszeitblatt können Sie genau wie in der Übersicht jeden gewünschten Zeitraum genauer betrachten. Klicken Sie auf das <FAIcon name="calendar" /> **Symbol**, um den Zeitraum auszuwählen, welcher angezeigt werden soll. Dabei kann maximal ein Zeitraum von 70 Tagen gewählt werden. 

<Figure caption="Im Arbeitszeitblatt können Sie einstellen welcher Zeitraum Ihnen genauer gezeigt wird.">
<img src="/mitarbeiter/arbeitszeiten/arbeitszeit_zeitraum.webp" />
</Figure>

> <FAIcon name="lightbulb" /> **Tipp:** Verwenden Sie Ihre Tastatur, um noch
schneller zwischen Monaten, Tagen und Einträgen zu wechseln! Mit der <Key>a</Key> Taste springen Sie in den vorherigen Monat, die <Key>d</Key> Taste
bringt Sie in den nächsten Monat. Mit der <Key>s</Key> Taste springen Sie in
die nächste Zeile, mit der <Key>w</Key> Taste selektieren Sie die vorherige
Zeile.
...
2. Falls bereits ein Eintrag an diesem Tag vorliegt, wird dieser automatisch zur
   Bearbeitung geöffnet. In diesem Fall müssen Sie zunächst <Button label="Neuer Eintrag" icon="plus" /> wählen. Ist der Tag noch leer, können
   Sie diesen Schritt überspringen.
3. Es öffnet sich ein Menü auf der rechten Seite. Wählen Sie hier die Option <Button label="Neue Schicht" />. Falls der Mitarbeiter mehreren
...
5. Ihre Eingaben werden automatisch gespeichert. Wenn Sie möchten, können Sie den
   Eintrag nun schließen, indem sie den <Button label="Zurück" icon="chevron-left" /> Button klicken oder <Key>Esc</Key> auf Ihrer Tastatur
   drücken.

> <FAIcon name="lightbulb" /> **Tipp:** Falls Sie bereits Arbeitszeiten für diesen
...
> Mehr zu Schichtvorschlägen erfahren Sie im [<FAIcon name="table" />
...
> <FAIcon name="lightbulb" /> **Tipp:** Um beim Selektieren eines Eintrags direkt in
...
<img src="/mitarbeiter/arbeitszeiten/bearbeitungsformular.png" />
</Figure>

### Position

Unter dem Punkt <FAIcon name="user" /> **Position** können Sie über ein Dropdown-Menü
...
Unter dem Punkt <FAIcon name="calendar" /> **Geplant** können Sie den geplanten
Schichtbeginn, das geplante Schichtende sowie die geplante Pause bearbeiten.

> <FAIcon name="info-circle" /> **Hinweis:** Dieser Bereich ist nur bearbeitbar,
...
> <FAIcon name="lightbulb" /> **Tipp:** Lassen Sie eines oder beide dieser Felder
...
Über das rechte Eingabefeld (erkennbar durch das <FAIcon name="coffee" /> Symbol)
...
zur Anwendung kommen, erfahren Sie in dem Hilfeartikel [<FAIcon name="cog" />
Einstellungen / <FAIcon name="stopwatch" />
Zeiterfassung]\(/handbuch/einstellungen/zeiterfassung#pausenberechnung).

### Gestempelte Arbeitszeiten

Unter dem Punkt <FAIcon name="stopwatch" /> **Gestempelt** finden Sie die über die
...
Unter dem Punkt <FAIcon name="check" /> **Erfasst** können Sie die Schichtzeiten
...
> <FAIcon name="info-circle" /> **Hinweis:** Änderungen an den erfassten
...
> <FAIcon name="info-circle" /> **Hinweis:** Falls für die aktuelle Schicht der
...
Im Feld <FAIcon name="utensils" /> **Essen** können Sie eingeben, ob Mitarbeiteressen
für die aktuelle Schicht gebucht werden sollen. Es wird unterschieden zwischen
**<FAIcon name="pancakes" /> Frühstück**, **<FAIcon name="burger-fries" /> Mittagessen**
und **<FAIcon name="plate-utensils" /> Abendessen**.

> <FAIcon name="info-circle" /> Zusätzlich zu manuellen Buchen von Mitarbeiteressen
...
Über das Feld <FAIcon name="euro-sign" /> **Umsatz** können Sie erfassen, wie viel
Umsatz der Mitarbeiter während der Schicht eingenommen hat. Dieser Wert wird für
die Berechnung der Provision herangezogen.

> <FAIcon name="info-circle" /> **Hinweis:** Dieses Feld ist nur dann bearbeitbar,
> wenn im Vertrag des Mitarbeiters eine Provision hinterlegt ist.

### Bemerkungen

Über das <FAIcon name="comment" /> **Bemerkungen**-Feld können Sie einen Kommentar für die Schicht hinterlegen.

### Zeiterfassungs-Regeln

Unter dem Punkt <FAIcon name="sliders-h" /> **Regeln** sehen Sie den für diese
Schicht geltenden
...
> <FAIcon name="lightbulb" /> **Tipp:** Sie wissen nicht, was die angezeigten Symbole
...
3. Der Eintrag ist nun gelöscht. Wenn Sie möchten, können Sie die Tagesansicht
   ...
   Button klicken oder <Key>Esc</Key> auf Ihrer Tastatur drücken.

> <FAIcon name="lightbulb" /> **Tipp:** Mit der Tastenkombination <Key>⇧</Key> **+**
> <span class='fake-button'> <FAIcon name="delete-left" /> </span> löschen Sie eine
...
2. Es öffnet sich ein Menü auf der rechten Seite. Klicken Sie hier auf den <Button label="Frei" /> oder <Button label="Guttag" /> Button oder drücken
   Sie die <Key>f</Key> Taste auf Ihrer Tastatur für "Frei" oder die <Key>g</Key> Taste für "Guttag".
3. Der Eintrag wird automatisch gespeichert. Wenn Sie möchten, können Sie die
   Tagesansicht nun schließen, indem sie den <Button label="Zurück" icon="chevron-left" /> Button klicken oder <Key>Esc</Key> auf Ihrer Tastatur
   drücken.

> <FAIcon name="info-circle" /> **Hinweis:** Freie Tage dienen nur als
> Platzhalter/Planhilfe und haben keinen Einfluss auf das Arbeitszeitkonto oder
> die Zeiterfassung.

### Guttage zum Feiertagsausgleich nutzen

Wenn Sie die [Sollstundenberechnung](/mitarbeiter/vertrag/) Ihrer Mitarbeiter **monatsgenau oder nach festen Wochentagen** durchführen, reduzieren sich die Sollstunden nicht, trotz Feiertag. Um zu verhindern, dass für diese Mitarbeiter Minderstunden anfallen, wenn sie keinen Einsatz am Feiertag haben, können Sie durch einen Guttag die Ist-Stunden ausgleichen.
...
2. Es öffnet sich ein Menü auf der rechten Seite. Klicken Sie hier auf den <Button label="Urlaub" /> oder <Button label="Krank" /> Button oder drücken
   Sie die <Key>u</Key> Taste auf Ihrer Tastatur für "Urlaub" oder die <Key>k</Key> Taste für "Krank".
3. Es öffnet sich ein Dialog, in dem Sie den Abweisenheits-Zeitraum und die zu
   ...
   Informationen zur Erfassung von Abwesenheiten finden Sie im [<FAIcon name="umbrella-beach" />
   Abwesenheiten]\(/handbuch/mitarbeiter/abwesenheiten#neue-abwesenheit-erfassen)
   Hilfeartikel.

> <FAIcon name="info-circle" /> **Hinweis:** aus Gründen der Übersichtlichkeit haben
...
> <FAIcon name="person-chalkboard" /> **Beispiel:** Ein Mitarbeiter hat eine
...
<img src="/mitarbeiter/arbeitszeiten/überstunden_ausbezahlen.gif" />
</Figure>
...
> <FAIcon name="lightbulb" /> **Tipp:** Sie können neben ganzen Urlaubstagen auch
...
> <FAIcon name="person-chalkboard" /> **Beispiel:** Ein Mitarbeiter hat eine größere
...
Klicken Sie auf das <FAIcon name="download" /> mittig-oben auf dem
Arbeitszeitblatt, um auf den Reiter <Button label="Datenexport" icon="download" /> verwiesen zu werden. Dort können Sie die Bewegungsdaten
...
2. Klicken Sie auf das <FAIcon name="file-lock" /> Symbol in der rechten oberen Ecke.
...
> <FAIcon name="exclamation-triangle" /> **Achtung:** Das Festschreiben von Konten kann **nicht rückgängig gemacht werden!**

<Figure caption="Das Festschreiben der Konten sorgt dafür, dass diese rückwirkend nicht mehr verändert werden können.">
<img src="/mitarbeiter/arbeitszeiten/konten_festschreiben.webp" />
</Figure>