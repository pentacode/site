...
> <FAIcon name="lightbulb" /> **Tipp:** Das Eingeben einer Nachricht mit dem Versand der Einladung ist optional -
...
<img src="/mitarbeiter/zugaenge-rechte/zugang_einrichten.gif" />
</Figure>
...
3. Wählen Sie die gewünschten Empfänger durch Anwählen
   des <Button icon="toggle-on" /> Buttons in der entsprechenden Zeile oder verwenden Sie den <Button label="Alle" icon="toggle-off" /> Button, um alle Mitarbeiter zu selektieren.
...
> <FAIcon name="lightbulb" /> Die Zahl neben dem <FAIcon name="people-group" />
Symbol gibt an, wie viele Mitarbeiter der Zuständigkeitsbereich eines Managers beinhaltet.

<figure>
<img src="/mitarbeiter/zugaenge-rechte/zustaendigkeitsbereiche.png" />
...
<figure>
<img src="/mitarbeiter/zugaenge-rechte/uebersicht.png" />
