...
> <Icon name="lightbulb" /> **Tipp:** Das Eingeben einer Nachricht mit dem Versand der Einladung ist optional -
...
> <Icon name="lightbulb" /> Die Zahl neben dem <Icon name="people-group" />
