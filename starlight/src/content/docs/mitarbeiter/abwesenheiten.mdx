...
> <Icon name="lightbulb" /> **Tipp:** Möchten Sie die nur die Abwesenheiten einer bestimmten Abteilung oder Anstellungsarten sehen? Über das
> <Icon name="filter" />-Symbol in der linken oberen Ecke können Sie die Anzeige auf Mitarbeiter aus einer oder mehrerer bestimmter Abteilungen oder Vertragsarten beschränken.
...
> <Icon name="exclamation-triangle" /> **Achtung - halbe Urlaubstage an Heiligabend und Silvester:** Wenn Sie einen halben Urlaubstag buchen und vermeiden wollen, 
