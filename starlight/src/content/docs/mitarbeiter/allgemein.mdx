...
Um einen neuen Mitarbeiter anzulegen, wählen Sie zunächst den Punkt <Button label="Mitarbeiter" icon="users" /> im
Hauptmenü und klicken Sie dort auf den Button <Button label="Neuer Mitarbeiter" icon="plus" />. Es öffnet sich ein
...
1. Wählen Sie den Punkt <Button label="Mitarbeiter" icon="users" /> im Hauptmenü
...
2. Klicken Sie den Button <Button label="Einstellen" icon="handshake-angle" /> unter dem Namen
   des Mitarbeiters.
...
2. Öffnen Sie das Aktions-Menü über den <Button icon="ellipsis-h" />-Button und
   wählen Sie dort die Option <Button label="Mitarbeiter Entlassen" icon="person-to-door" />.
...
2. Öffnen Sie das Aktions-Menü über den <Button icon="ellipsis-h" />-Button und
   wählen Sie dort die Option <Button label="Wiedereinstellen" icon="person-walking-arrow-loop-left" />.
...
1. Wählen Sie den Punkt <Button label="Mitarbeiter" icon="users" /> im Hauptmenü
   ...
   <Button label="Alle Mitarbeiter" iconRight="caret-down" /> in der linken oberen Ecke.
2. Öffnen Sie das Aktions-Menü über den <Button icon="ellipsis-h" />-Button und
   wählen Sie dort die Option <Button label="Mitarbeiter Löschen" icon="trash-alt" />.
3. Bestätigen Sie die Aktion durch einen Klick auf den <Button label="Löschen" />-Button.

> <FAIcon name="exclamation-triangle" /> **Achtung:** Durch das Löschen eines Mitarbeiters werden nicht nur dessen
