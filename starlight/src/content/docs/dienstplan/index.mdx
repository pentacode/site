...
<Figure>
<img src="/dienstplan/dienstplan_uebersicht.webp" />
</Figure>
...
klicken Sie den <FAIcon name="caret-down" /> oder <FAIcon name="caret-up" /> Pfeil.
...
<img src="/dienstplan/dienstplan_zeitraum.gif" />
</Figure>
...
2. Klicken Sie auf <Button label="Notiz" icon="sticky-note" />.
...
<img src="/dienstplan/kalendereintrag.gif" />
</Figure>

> <FAIcon name="lightbulb" /> **Tipp:** Sie können durch einen Klick auf das <FAIcon name="tv-retro" /> **Icon** im rechten oberen Eck durch an- und abwählen des grünen Hakens bei Kalendereinträge Notizen an und Abwählen.
...
bearbeiten**, durch einen Klick auf den <FAIcon name="trash-alt" />-**Button** können
...
Wenn Sie die Kalendereinträge im Ansichtsmenü <FAIcon name="tv-retro" /> angewählt haben, werden Ihnen automatisch die Schulferien des Bundeslandes angezeigt, das in ihrem Standort hinterlegt ist. Damit diese Funktion verfügbar ist, müssen Sie die [Standorteinstellungen](/einstellungen/arbeitsbereiche/) ausfüllen.

## Wetteranzeige

Um bei ihrer Dienstplanung auch das aktuelle Wetter berücksichtigen zu können, zeigt Ihnen Pentacode die aktuelle Vorhersage für die nächsten 16 Tage an. Dabei werden die [Daten des Standorts](/einstellungen/arbeitsbereiche/) verwendet, wodurch sich **die Vorhersage an den ausgewählten Standort anpasst.**

Um die Wetteranzeige an- und auszuschalten, klicken Sie auf das (<FAIcon name="tv-retro" />-Icon) und setzen bei **Wetter** einen grünen Haken.
...
<img src="/dienstplan/wettervorhersage.gif" />
</Figure>
...
auswählen und auf das <FAIcon name="filter" /> **Symbol** klicken. Es öffnet sich ein
...
Einen neuen Tab erstellen Sie, indem Sie auf den <Button icon="rectangle-history" /> **Button** mit dem aktuellen Tab und anschließend auf <FAIcon name="plus" /> klicken. Es wird automatisch ein neuer Tab
...
<FAIcon name="trash" />-**Button** in der rechten oberen Ecke.

> <FAIcon name="lightbulb" /> Da immer mindestens ein Tab existieren muss, ist der Löschen-Button
...
Um die Filter-Einstellungen eines Tabs zu bearbeiten, klicken Sie auf das <FAIcon name="filter" /> **Symbol** (Siehe auch [Tab Bearbeiten](#tab-bearbeiten)).

<Figure caption="Mit Abteilungs- und Zeitfiltern können Sie sich nur die gewünschten Spätschichten anzeigen lassen.">
<img src="/dienstplan/dienstplan_filter.gif" />
</Figure>

> <FAIcon name="lightbulb" /> **Tipp:** Wechseln Sie häufig zwischen mehreren
...
> **Tipp**: Mit den Tasten <Key class="mono">w</Key> **(auf)**, <Key class="mono">s</Key> **(ab)**, <Key class="mono">a</Key> **(links)** und <Key class="mono">d</Key> **(rechts)** wechseln Sie schnell zwischen Mitarbeitern, Einträgen und Tagen.
...
> zwischen Einträgen, Mitarbeitern und Tagen springen. Über die <Key class="mono">Esc</Key> -**Taste** schließen sie die Tagesansicht. Probieren Sie es aus!

<Figure caption="In der Tagesansicht können Sie Einträge bearbeiten und Informationen zum gewählten Mitarbeiter einsehen.">
<img src="/dienstplan/tagesansicht.webp" />
</Figure>
...
[Planungshilfen](#planungshilfen)(das <FAIcon name="tv-retro" />-Icon) **'Vorschläge & Favoriten'** anwählen. Um
...
<img src="/dienstplan/globale_schichtvorschlaege.gif"/>
</Figure>

#### Schichtvorschläge favorisieren

**Klicken Sie auf den Stern** neben einem globalen Schichtvorschlag, wird dieser
favorisiert. Wenn Sie auf den Stern neben <Button label="Vorschläge & Favoriten" icon="lightbulb-on" /> klicken, werden Ihnen **nur die favorisierten
...
[Tagesansicht](#tagesansicht) im Menü <FAIcon name="plus" /> **Neuer Eintrag**.
...
> <Key class="mono">1</Key>). Diese deutet an, dass Sie den Vorschlag über die
> entsprechende Ziffer auf Ihrer Tastatur wählen können. In Kombination mit den
> Tasten <Key>w</Key> <Key class="mono">s</Key> <Key class="mono">a</Key> <Key class="mono">d</Key> (siehe [Tagesansicht](#tagesansicht)) können Sie
...
[Planungshilfen](#planungshilfen)(das <FAIcon name="tv-retro" />-Icon) mit einem
Klick auf das Feld <Button label="Nicht Zugewiesen" icon="user-slash" />.
...
> <FAIcon name="lightbulb" /> **Tipp:** Mit der [automatischen Schichtzuweisung](#automatische-schichtzuweisung) können Sie nicht zugewiesene Schichten schnell auf ihre Belegschaft verteilen!

<Figure caption="So erstellen Sie Schichten, die allen verfügbaren Mitarbeitern der Abteilung zur Auswahl stehen">
<img src="/dienstplan/nicht_zugewiesen.webp" />
</Figure>

### Schichtzuweisungen aufheben

<span style="color: purple;"> <FAIcon name="info-circle" /> **Beta Feature! Schichtzuweisungen aufheben ist bisher nur für Beta Kunden freigeschaltet!** </span>

Sie können alle Zuweisungen der geplanten Schichten im Dienstplan auf einmal aufheben. Klicken Sie dazu auf das <FAIcon name="wrench" />-Icon und auf <FAIcon name="user-slash" /> **Schichtzuweisung aufheben**. Alle Schichten werden nun nach "nicht zugewiesen" verschoben. 

> <FAIcon name="lightbulb" /> **Tipp:** Wenn Sie die Anzahl und Länge der Schichten aus einer [Vorlage](#vorlage-anwenden) in der Planung verwenden wollen, aber nicht die genaue Zuweisung an die Mitarbeiter: Wenden Sie erst eine Vorlage an und heben Sie dann die Schichtzuweisungen auf. Anschließend können Sie die Schichten wie gewünscht an die Mitarbeiter aufteilen oder [automatisch zuweisen lassen](#automatische-schichtzuweisung).

## Automatische Schichtzuweisung

<span style="color: purple;"> <FAIcon name="info-circle" /> **Beta Feature! Automatische Schichtzuweisungen ist bisher nur für Beta Kunden freigeschalten!** </span>
...
1. **Dienstplan vorbereiten:**
  ...
  - Aktivieren Sie über das <FAIcon name="tv-retro" />-Icon die [Nicht zugewiesenen Schichten](#nicht-zugewiesene-schichten). Es erscheint nun unter jeder Abteilung der Bereich "Nicht zugewiesen".
...
2. **Schichten automatisch zuweisen:**
  - Klicken Sie auf das <FAIcon name="wrench" />-Icon im Dienstplan-Menü.

  - Wählen Sie den <Button label="Schichten automatisch zuweisen" icon="robot" />-Button aus.
...
<img src="/dienstplan/automatische_schichten.gif" />
</Figure>
...
Wenn Sie in den [Planungshilfen](#planungshilfen) (das <FAIcon name="tv-retro" />-Icon) **'Vorschläge & Favoriten'** angewählt haben finden Sie auf der rechten
...
> <FAIcon name="lightbulb" /> **Tipp:** Fehltage können auch über die Tastaturkürzel <Key class="mono">u</Key> **(Urlaub)**, <Key class="mono">k</Key> **(Krank)**, <Key class="mono">g</Key> **(Guttag)** und <Key class="mono">f</Key> **(Frei)** gewählt werden!
...
<Key class="mono">alt</Key>-**Taste** gedrückt halten wird der Eintrag nicht
...
Um einen Eintrag zu löschen, klicken sie einfach auf das <FAIcon name="times" /> in
...
> <FAIcon name="lightbulb" /> **Tipp:** Selektierte Einträge können außerdem über das
> Tastenkürzel <Key>⇧</Key> + <Key>⌫</Key> gelöscht werden!
...
einzeln aufgelistet sehen wollen, klicken Sie auf das <FAIcon name="pencil" /> Symbol
...
dem <FAIcon name="pencil" /> Symbol an, wie viele Änderungen seit der letzten
...
Änderungen erneut aufgelistet sind. Hier können Sie [auswählen](#änderungen-einsehen-und-auswählen), welche Änderungen Sie veröffentlichen wollen. Klicken Sie auf <Button label="Veröffentlichen" icon="lightbulb" /> zeigt Pentacode an, welche betroffenen
...
> <FAIcon name="lightbulb" /> **Tipp:** Um Mitarbeiter von Änderungen an ihrem
...
<img src="/dienstplan/veröffentlichen.gif" />
</Figure>

### Änderungen zurücksetzen

Im gleichen Menü zum [Veröffentlichen von Änderungen](#änderungen-veröffentlichen) können Sie die vorgenommenen Änderungen auch zurücksetzen. Klicken Sie dazu auf <Button label="Rückgängig machen" icon="rotate-left" /> und bestätigen Sie den Vorgang. Es werden auch hier nur die [ausgewählten Änderungen](#änderungen-einsehen-und-auswählen) zurückgesetzt. 

## Dienstplan Teilen

Sie können ihren Dienstplan auch mit Personen teilen, die keinen Zugang zur
Mitarbeiterapp haben. Klicken Sie dazu auf den <FAIcon name="share" />-**Button** im
...
- Klicken Sie auf <Button label="Kopieren" icon="clipboard" />, um den Link an
  anderer Stelle mit <Key>strg</Key> **+** <Key>V</Key> einzusetzen.
- Klicken Sie auf <Button label="Versenden" icon="envelope" />, um ihrer
...
> <FAIcon name="person-chalkboard" /> **Beispiel:** In unserem Tab "Frühschicht" werden Spät- und
...
<img src="/dienstplan/dienstplan_teilen.gif" />
</Figure>
...
können Sie über das Tastenkürzel <Key class="mono">strg</Key> <Key class="mono">P</Key>
(bzw. <Key class="mono">cmd</Key> <Key class="mono">P</Key> auf MacOS) oder über das
...
erst auf den <FAIcon name="share" />-**Button** und anschließend auf <Button label="Drucken" icon="print" />.
...
die Vorlagen-Liste mit einem Klick auf den Button <FAIcon name="floppy-disc-circle-arrow-right" />
**Vorlagen** und klicken auf den Button <FAIcon name="plus" /> **Neue Vorlage**.
...
<img src="/dienstplan/vorlage_erstellen.webp" />
</Figure>
...
dann mit der Maus über die gewünschte Vorlage und klicken Sie den <FAIcon name="trash" />-**Icon**. Klicken Sie **Entfernen** im darauffolgenden
Bestätigungsdialog, um den Vorgang abzuschließen.

## Dienstplan Leeren

Um den gesamten Dienstplan zu leeren, klicken Sie das
<FAIcon name="wrench" />-**Icon** in der oberen rechten Ecke des Dienstplanmenüs. Sie
können nun das Feld <Button label="Dienstplan Leeren" icon="trash" />
...
> <FAIcon name="lightbulb" /> **Wichtig:** Die Planungshilfen können Sie mit einem Klick
> auf das <FAIcon name="tv-retro" />  **Icon** im rechten oberen Eck aktivieren und deaktivieren.
...
Dienstplan-Menü bei dem roten <FAIcon name="exclamation-triangle" /> Symbol
...
<img src="/dienstplan/problem.gif" />
</Figure>
...
"Schichten Spiegeln"-Funktion kann über das <FAIcon name="tv-retro" /> **Icon**
...
<img src="/dienstplan/verfügbarkeiten.webp" />
</Figure>
...
zu haben, hilft Ihnen die <Button label="Überst. Vorher/Nachher" icon="plus-minus" /> Funktion in den [Planungshilfen](#planungshilfen). Wenn diese Funktion
...
Über das <FAIcon name="grid-3" /> **Symbol** in den [Planungshilfen](#planungshilfen) können Sie den Dienstplan
...
Mit einem Klick auf das <FAIcon name="grid-4" /> **Symbol** können Sie sich den
...
<img src="/dienstplan/kompakte_darstellung.gif" />
</Figure>

### Personalkostenanalyse

Für eine effiziente Personalplanung ist es essenziell, immer einen Überblick
über die entstehenden Personalkosten zu haben. Über den <FAIcon name="chart-line" />-**Button** in den [Planungshilfen](#planungshilfen) erhalten Sie nicht nur eine direkte
...
Durch das Anklicken des <FAIcon name="chart-line" />-**Symbols** erscheinen am Fuß
...
> <FAIcon name="lightbulb" /> **Tipp:** Sollten sich die **Felder** mit Angabe der
...
<img src="/dienstplan/plan_vergleich.gif" />
</Figure>

Durch **erneutes Anklicken** des <FAIcon name="chart-line" />-**Symbols** wird die
