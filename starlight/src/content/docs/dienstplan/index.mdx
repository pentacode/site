...
klicken Sie den <Icon name="caret-down" /> oder <Icon name="caret-up" /> Pfeil.
...
> <Icon name="lightbulb" /> **Tipp:** Sie können durch einen Klick auf das <Icon name="tv-retro" /> **Icon** im rechten oberen Eck durch an- und abwählen des grünen Hakens bei Kalendereinträge Notizen an und Abwählen.
...
bearbeiten**, durch einen Klick auf den <Icon name="trash-alt" />-**Button** können
...
Wenn Sie die Kalendereinträge im Ansichtsmenü <Icon name="tv-retro" /> angewählt haben, werden Ihnen automatisch die Schulferien des Bundeslandes angezeigt, das in ihrem Standort hinterlegt ist. Damit diese Funktion verfügbar ist, müssen Sie die [Standorteinstellungen](/einstellungen/arbeitsbereiche/) ausfüllen.
...
Um die Wetteranzeige an- und auszuschalten, klicken Sie auf das (<Icon name="tv-retro" />-Icon) und setzen bei **Wetter** einen grünen Haken.
...
auswählen und auf das <Icon name="filter" /> **Symbol** klicken. Es öffnet sich ein
...
Einen neuen Tab erstellen Sie, indem Sie auf den <Button icon="rectangle-history" /> **Button** mit dem aktuellen Tab und anschließend auf <Icon name="plus" /> klicken. Es wird automatisch ein neuer Tab
...
<Icon name="trash" />-**Button** in der rechten oberen Ecke.

> <Icon name="lightbulb" /> Da immer mindestens ein Tab existieren muss, ist der Löschen-Button
...
Um die Filter-Einstellungen eines Tabs zu bearbeiten, klicken Sie auf das <Icon name="filter" /> **Symbol** (Siehe auch [Tab Bearbeiten](#tab-bearbeiten)).
...
> <Icon name="lightbulb" /> **Tipp:** Wechseln Sie häufig zwischen mehreren
...
[Planungshilfen](#planungshilfen)(das <Icon name="tv-retro" />-Icon) **'Vorschläge & Favoriten'** anwählen. Um
...
[Tagesansicht](#tagesansicht) im Menü <Icon name="plus" /> **Neuer Eintrag**.
...
[Planungshilfen](#planungshilfen)(das <Icon name="tv-retro" />-Icon) mit einem
...
> <Icon name="lightbulb" /> **Tipp:** Mit der [automatischen Schichtzuweisung](#automatische-schichtzuweisung) können Sie nicht zugewiesene Schichten schnell auf ihre Belegschaft verteilen!
...
<span style="color: purple;"> <Icon name="info-circle" /> **Beta Feature! Schichtzuweisungen aufheben ist bisher nur für Beta Kunden freigeschaltet!** </span>

Sie können alle Zuweisungen der geplanten Schichten im Dienstplan auf einmal aufheben. Klicken Sie dazu auf das <Icon name="wrench" />-Icon und auf <Icon name="user-slash" /> **Schichtzuweisung aufheben**. Alle Schichten werden nun nach "nicht zugewiesen" verschoben. 

> <Icon name="lightbulb" /> **Tipp:** Wenn Sie die Anzahl und Länge der Schichten aus einer [Vorlage](#vorlage-anwenden) in der Planung verwenden wollen, aber nicht die genaue Zuweisung an die Mitarbeiter: Wenden Sie erst eine Vorlage an und heben Sie dann die Schichtzuweisungen auf. Anschließend können Sie die Schichten wie gewünscht an die Mitarbeiter aufteilen oder [automatisch zuweisen lassen](#automatische-schichtzuweisung).

## Automatische Schichtzuweisung

<span style="color: purple;"> <Icon name="info-circle" /> **Beta Feature! Automatische Schichtzuweisungen ist bisher nur für Beta Kunden freigeschalten!** </span>
...
1. **Dienstplan vorbereiten:**
  ...
  - Aktivieren Sie über das <Icon name="tv-retro" />-Icon die [Nicht zugewiesenen Schichten](#nicht-zugewiesene-schichten). Es erscheint nun unter jeder Abteilung der Bereich "Nicht zugewiesen".
...
2. **Schichten automatisch zuweisen:**
  - Klicken Sie auf das <Icon name="wrench" />-Icon im Dienstplan-Menü.
...
Wenn Sie in den [Planungshilfen](#planungshilfen) (das <Icon name="tv-retro" />-Icon) **'Vorschläge & Favoriten'** angewählt haben finden Sie auf der rechten
...
> <Icon name="lightbulb" /> **Tipp:** Fehltage können auch über die Tastaturkürzel <Key class="mono">u</Key> **(Urlaub)**, <Key class="mono">k</Key> **(Krank)**, <Key class="mono">g</Key> **(Guttag)** und <Key class="mono">f</Key> **(Frei)** gewählt werden!
...
Um einen Eintrag zu löschen, klicken sie einfach auf das <Icon name="times" /> in
...
> <Icon name="lightbulb" /> **Tipp:** Selektierte Einträge können außerdem über das
...
einzeln aufgelistet sehen wollen, klicken Sie auf das <Icon name="pencil" /> Symbol
...
dem <Icon name="pencil" /> Symbol an, wie viele Änderungen seit der letzten
...
> <Icon name="lightbulb" /> **Tipp:** Um Mitarbeiter von Änderungen an ihrem
...
Mitarbeiterapp haben. Klicken Sie dazu auf den <Icon name="share" />-**Button** im
...
> <Icon name="person-chalkboard" /> **Beispiel:** In unserem Tab "Frühschicht" werden Spät- und
...
erst auf den <Icon name="share" />-**Button** und anschließend auf <Button label="Drucken" icon="print" />.
...
die Vorlagen-Liste mit einem Klick auf den Button <Icon name="floppy-disc-circle-arrow-right" />
**Vorlagen** und klicken auf den Button <Icon name="plus" /> **Neue Vorlage**.
...
dann mit der Maus über die gewünschte Vorlage und klicken Sie den <Icon name="trash" />-**Icon**. Klicken Sie **Entfernen** im darauffolgenden
Bestätigungsdialog, um den Vorgang abzuschließen.

## Dienstplan Leeren

Um den gesamten Dienstplan zu leeren, klicken Sie das
<Icon name="wrench" />-**Icon** in der oberen rechten Ecke des Dienstplanmenüs. Sie
...
> <Icon name="lightbulb" /> **Wichtig:** Die Planungshilfen können Sie mit einem Klick
> auf das <Icon name="tv-retro" />  **Icon** im rechten oberen Eck aktivieren und deaktivieren.
...
Dienstplan-Menü bei dem roten <Icon name="exclamation-triangle" /> Symbol
...
"Schichten Spiegeln"-Funktion kann über das <Icon name="tv-retro" /> **Icon**
...
Über das <Icon name="grid-3" /> **Symbol** in den [Planungshilfen](#planungshilfen) können Sie den Dienstplan
...
Mit einem Klick auf das <Icon name="grid-4" /> **Symbol** können Sie sich den
...
über die entstehenden Personalkosten zu haben. Über den <Icon name="chart-line" />-**Button** in den [Planungshilfen](#planungshilfen) erhalten Sie nicht nur eine direkte
...
Durch das Anklicken des <Icon name="chart-line" />-**Symbols** erscheinen am Fuß
...
> <Icon name="lightbulb" /> **Tipp:** Sollten sich die **Felder** mit Angabe der
...
Durch **erneutes Anklicken** des <Icon name="chart-line" />-**Symbols** wird die
